...
-- that have more than one person in the state? Select the state and display
-- the number of how many people are in each if it's greater than 1.
...
-- Only display the results if the maximum price for one of the items
...
-- BONUS. Order them by number of orders.
